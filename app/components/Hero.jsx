...
const Hero = () => {
  return (
    <section
      id="hero"
      className="flex items-center min-h-[90dvh] bg-hero-image-sm md:bg-hero-image bg-cover bg-center lg:mt-16"
    >
      <div className="z-0 flex items-center justify-center max-w-7xl gap-4 p-4 mb-32 md:mb-0">
        <main className="md:max-w-80 lg:max-w-md md:ml-12 lg:ml-28 text-center md:text-left">
          <h1 className="my-8 lg:my-0 border md:mb-5 text-2xl text-slate-800 md:text-3xl lg:text-5xl font-bold font-ps">
            Simply Authentic, Simply Exceptional.
          </h1>
          <p className="my-6 text-gray-500 text-sm md:my-8 md:text-base lg:text-lg">
